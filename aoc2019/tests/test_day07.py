...
from .day7 import (amplify, feedback_amplify)


class MyTestCase(unittest.TestCase):
    def test_tc1(self):
        self.assertEqual(amplify([3, 15, 3, 16, 1002, 16, 10, 16, 1, 16, 15, 15, 4, 15, 99, 0, 0], [4, 3, 2, 1, 0]),
                         43210)

    def test_tc2(self):
        self.assertEqual(
            amplify([3, 23, 3, 24, 1002, 24, 10, 24, 1002, 23, -1, 23, 101, 5, 23, 23, 1, 24, 23, 23, 4, 23, 99, 0, 0],
                    [0, 1, 2, 3, 4]), 54321)
    ...
    def test_tc4(self):
        self.assertEqual(feedback_amplify(
